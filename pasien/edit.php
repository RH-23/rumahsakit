            ...
            <div class="col-lg-6 col-lg-offset-3">
                ...
                <form action="proses.php" method="post">
                	 <div class="form-group">
                        <label for="identitas">Nomer Identitas</label>
                        <input type="hidden" name="id" value="<?=$data['id_pasien']?>">
                        <input type="number" name="identitas" id="identitas" class="form-control" value="<?=$data['nomer_identitas']?>" required autofocus>
                    </div>
                    <div class="form-group">
